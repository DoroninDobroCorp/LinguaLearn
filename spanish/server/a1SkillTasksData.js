 ...
 */
export const A1_SKILL_TASKS = Object.freeze(
{
  "listening": [
    {
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            "Es profesora",
            "Es médica en un hospital infantil",
            "Es arquitecta",
            "Es guía turística"
          ],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            "Duerme cuatro horas",
            "Camina por el parque y estudia español",
            "Baila en una discoteca",
            "Va de compras"
          ],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            "Bañador y sandalias",
            "Chaqueta gruesa, jersey de lana y botas",
            "Traje y corbata",
            "Gafas de sol y camiseta"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "A las seis en la tienda",
            "A las cinco en punto en la parada de metro",
            "A las cuatro en el hotel",
  ...
  "speaking": [
    {
      ...
      "rubric": {
        ...
        "criteria": [
          {
            "name": "Понятность и беглость речи",
            "max": 40,
            "description": "Речь разборчива, естественный темп, паузы не мешают пониманию."
          },
          {
            "name": "Целевая грамматика",
            "max": 30,
            "description": "Правильное употребление глаголов llamarse, tener, ser, hablar."
          },
          {
            "name": "Словарный запас A1",
            "max": 20,
            "description": "Слова по теме приветствий, возраста, стран и языков."
          },
          {
            "name": "Произношение и ударение",
            "max": 10,
            "description": "Четкие гласные (o/a/e), правильное ударение в числах и глаголах."
          }
        ]
      }
    },
    {
      ...
      "rubric": {
        ...
        "criteria": [
          {
            "name": "Понятность и связность",
            "max": 40,
            "description": "Логичное и связное описание пространства."
          },
          {
            "name": "Целевая грамматика",
            "max": 30,
            "description": "Корректное согласование артиклей, существительных и цветов."
          },
          {
            "name": "Словарный запас A1",
            "max": 20,
            "description": "Лексика мебели (mesa, cama, armario) и цветов (blanco, rojo, azul)."
          },
          {
            "name": "Произношение",
            "max": 10,
            "description": "Четкое произношение окончаний -o/-a/-os/-as."
          }
        ]
      }
    },
    {
      ...
      "rubric": {
        ...
        "criteria": [
          {
            "name": "Понятность высказывания",
            "max": 40,
            "description": "Четкая структура описания человека."
          },
          {
            "name": "Целевая грамматика",
            "max": 30,
            "description": "Правильное разделение функций SER, TENER и LLEVAR."
          },
          {
            "name": "Словарь внешности и характера",
            "max": 20,
            "description": "Слова alto, delgado, pelo liso/rizado, ojos marrones, gafas..."
          },
          {
            "name": "Произношение",
            "max": 10,
            "description": "Правильное ударение в глаголах (tiene, lleva, es)."
          }
        ]
      }
    },
    {
      ...
      "rubric": {
        ...
        "criteria": [
          {
            "name": "Понятность и беглость",
            "max": 40,
            "description": "Плавный рассказ без длительных пауз."
          },
          {
            "name": "Целевая грамматика",
            "max": 30,
            "description": "Спряжение глаголов в 1-м лице и конструкции времени (a las ocho)."
          },
          {
            "name": "Словарный запас распорядка",
            "max": 20,
            "description": "Слова levantarse, desayunar, trabajar, comer, cenar, acostarse."
          },
          {
            "name": "Произношение",
            "max": 10,
            "description": "Интонация утвердительных предложений."
          }
        ]
      }
    },
    {
      ...
      "rubric": {
        ...
        "criteria": [
          {
            "name": "Коммуникативная понятность и этикет",
            "max": 40,
            "description": "Естественный ресторанный этикет (por favor, gracias)."
          },
          {
            "name": "Целевая грамматика",
            "max": 30,
            "description": "Формулы заказа «de primero / para beber / la cuenta»."
          },
          {
            "name": "Лексика блюд и напитков",
            "max": 20,
            "description": "Слова sopa, ensalada, carne, pescado, agua, vino, postre, cuenta."
          },
          {
            "name": "Произношение",
            "max": 10,
            "description": "Интонация вопросов и просьб."
          }
        ]
      }
    },
    {
      ...
      "rubric": {
        ...
        "criteria": [
          {
            "name": "Понятность и уверенность речи",
            "max": 40,
            "description": "Логичное изложение планов на будущее."
          },
          {
            "name": "Целевая грамматика",
            "max": 30,
            "description": "Обязательное использование конструкции «IR A + инфинитив» и «GUSTAR»."
          },
          {
            "name": "Словарный запас A1",
            "max": 20,
            "description": "Дни недели, покупки, одежда, досуг."
          },
          {
            "name": "Произношение",
            "max": 10,
            "description": "Четкость и связность фраз."
          }
        ]
      }
    }
      ...
      "questions": [
        {
          ...
          "options": [
            "En la planta baja",
            "En el primer piso",
            "En el segundo piso con ascensor",
            "En el cuarto piso"
          ],
          "correctIndex": 2,
      ...
      "questions": [
        {
          ...
          "options": [
            "Porque tiene vacaciones",
            "Porque está enfermo con fiebre y dolor de cabeza",
            "Porque es domingo",
            "Porque va de viaje"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Joven y antipático",
            "Un hombre mayor, muy amable y paciente",
            "Extranjero",
            "Tímido"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            "Hacer deporte",
            "Descansar en la cama tres días, beber agua y tomar medicamento",
            "Ir al cine",
            "Comer helado"
          ],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            "Pizza y hamburguesa",
            "Tortilla de patatas, jamón y ensaladilla rusa",
            "Solo fruta",
            "Sopa caliente"
          ],
          "correctIndex": 1,
      ...
      "questions": [
        {
          ...
          "options": [
            "Solo manzanas",
            "Naranjas de Valencia, plátanos y fresas frescas",
            "Uvas y limones",
            "Piña y sandía"
          ],
          "correctIndex": 1,
        ...
        },
        {
          ...
          "options": [
            ...
            "En efectivo con billetes de veinte euros",
            "Con el teléfono",
            "No paga"
          ],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            "Dormir",
            "Ir de compras a las rebajas del centro",
            "Cocinar paella",
        ...
        },
        {
          ...
          "options": [
            "Una bufanda y guantes",
            "Una chaqueta negra y unos zapatos cómodos",
            "Un bañador y gafas de sol",
            "Un sombrero y corbata"
          ],
          "correctIndex": 1,
  ...
  "writing": [
    {
      ...
      "rubric": {
        ...
        "criteria": [
          {
            "name": "Выполнение коммуникативной задачи",
            "max": 30,
            "description": "Представлены все запрашиваемые данные (имя, возраст, страна, языки)."
          },
          {
            "name": "Грамматическая правильность",
            "max": 30,
            "description": "Корректное использование глаголов llamarse, tener, ser, hablar."
          },
          {
            "name": "Словарный запас A1",
            "max": 25,
            "description": "Использование формул вежливости и лексики первого контакта."
          },
          {
            "name": "Связность и пунктуация",
            "max": 15,
            "description": "Логичное деление на предложения, знаки ¡! и ¿?, заглавные буквы."
          }
        ]
      }
    },
        ...
        "criteria": [
          {
            ...
            "max": 30,
            "description": "Описаны комнаты, мебель, цвета и атмосфера жилья."
          },
          {
            "name": "Грамматика рода и числа",
            "max": 30,
            "description": "Точное согласование артиклей и прилагательных (el sofá, la mesa blanca...)."
          },
          {
            "name": "Лексика дома и мебели",
            "max": 25,
            "description": "Слова salón, cocina, dormitorio, cama, mesa, armario, luminoso..."
          },
          {
            "name": "Связность текста",
            "max": 15,
            "description": "Плавные переходы между предложениями."
          }
        ]
      }
    },
        ...
        "criteria": [
          {
            "name": "Выполнение коммуникативной задачи",
            "max": 30,
            "description": "Полный портрет с внешностью, возрастом, профессией и характером."
          },
          {
            "name": "Триада SER / TENER / LLEVAR",
            "max": 30,
            "description": "Безошибочное использование SER для роста/характера и TENER для волос/глаз."
          },
          {
            "name": "Лексика внешности и характера",
            "max": 25,
            "description": "Слова alto, rubio/moreno, ojos marrones/azules, simpático, paciente..."
          },
          {
            "name": "Орфография и пунктуация",
            "max": 15,
            "description": "Правильные окончания -o/-a, акценты."
          }
        ]
      }
    },
    {
      ...
      "rubric": {
        ...
        "criteria": [
          {
            "name": "Выполнение задачи и формат письма",
            "max": 30,
            "description": "Формат дружеского письма с приветствием, распорядком и прощанием."
          },
          {
            "name": "Спряжение глаголов в Presente",
            "max": 30,
            "description": "Правильные личные окончания глаголов -AR, -ER, -IR."
          },
          {
            "name": "Лексика времени и распорядка",
            "max": 25,
            "description": "Слова despertarse, desayunar, trabajar, comer, estudiar, por la tarde..."
          },
          {
            "name": "Связность и пунктуация",
            "max": 15,
            "description": "Логика текста, заглавные буквы, запятые."
          }
        ]
      }
    },
        ...
        "criteria": [
          {
            "name": "Выполнение коммуникативной задачи",
            "max": 30,
            "description": "Описаны ресторан, меню, напитки, десерты, персонал и цены."
          },
          {
            "name": "Грамматическая точность",
            "max": 30,
            "description": "Правильное использование SER/ESTAR, глаголов питания и цен."
          },
          {
            "name": "Лексика гастрономии",
            "max": 25,
            "description": "Слова primer plato, sopa, carne, pescado, bebida, postre, camarero, cuenta."
          },
          {
            "name": "Связность и оформление",
            "max": 15,
            "description": "Логичная структура отзыва."
          }
        ]
      }
    },
        ...
        "criteria": [
          {
            "name": "Выполнение коммуникативной задачи",
            "max": 30,
            "description": "Полный план путешествия (направление, транспорт, попутчики, одежда, активности)."
          },
          {
            "name": "Конструкция будущего времени (IR A + inf.)",
            "max": 30,
            "description": "Многократное безошибочное использование voy a / vamos a + инфинитив."
          },
          {
            "name": "Богатый словарный запас A1",
            "max": 25,
            "description": "Слова по темам путешествий, транспорта, одежды, погоды и еды."
          },
          {
            "name": "Связность, орфография и пунктуация",
            "max": 15,
            "description": "Грамотное оформление развернутого текста."
          }
        ]
      }
    }
...
export function getA1SkillTasks(skill) {
