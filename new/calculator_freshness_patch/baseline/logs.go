...
// Live: 5 seconds, Prematch: 60 seconds.
...
func priceFreshnessDisabled() bool {
	value := strings.TrimSpace(strings.ToLower(os.Getenv("CALCULATOR_DISABLE_PRICE_FRESHNESS")))
